...
- 🧠 [mindmirror](https://github.com/artemgetmann/mindmirror) - long-term memory infrastructure for AI agents (MCP backend + retrieval API + vector db + optional frontend)
